...
/// @nodoc
mixin _$ModelWallet {
  List<EntityMyWallet> get originalWalletInfo =>
...
abstract class $ModelWalletCopyWith<$Res> {
  ...
  $Res call(
      {List<EntityMyWallet> originalWalletInfo,
      double totalAmount,
...
class _$_ModelWallet implements _ModelWallet {
  _$_ModelWallet(
      {required final List<EntityMyWallet> originalWalletInfo,
  ...
  final List<EntityMyWallet> _originalWalletInfo;
  @override
  List<EntityMyWallet> get originalWalletInfo {
