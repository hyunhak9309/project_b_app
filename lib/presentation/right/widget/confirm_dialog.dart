                ...
                children: [
                  Row(
                    ...
                    children: [
                      BText(
                        (deposit
                                ? RightController.to.depositController.text
                                : RightController.to.withdrawController.text) +
                            "KRW".tr,
                        18,
                  ...
                  Row(
                    ...
                    children: [
                      BInkWell(
                          ...
                          onTap: () {
                            if (deposit) {
                              RightController.to.depositController.clear();
                            } else {
                              RightController.to.withdrawController.clear();
                            }
                            Get.back();
                          }),
                      const SizedBox(
                      ...
                      BInkWell(
                          ...
                          onTap: () {
                            if (deposit) {
                              RightController.to.depositMoney();
                            } else {
                              RightController.to.withdrawMoney();
                            }
                            Get.back();
                          })
                    ],
